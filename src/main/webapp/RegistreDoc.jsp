...
<body class="flex items-center justify-center h-screen bg-gray-100">
    <div class="w-full max-w-md p-8 bg-white rounded-lg shadow-lg">
        <h2 class="text-2xl font-semibold text-center text-gray-700 mb-6">Inscription Médecin</h2>
        <form action="RegisterMedecinServlet" method="post" class="space-y-4">
            <div>
            ...
            <div>
                ...
                <input type="text" name="specialite" required class="w-full p-3 border rounded-lg focus:ring focus:ring-blue-300">
            </div>
            <div>
